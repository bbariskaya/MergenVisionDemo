...
# create two small device tensors different sizes
h1,w1=250,250
h2,w2=200,300
...
try:
    batched = cvcuda.stack([t1,t2])
    print('stack ok', batched.shape)
except Exception as e:
    print('stack error', e)
try:
    resized = cvcuda.resize([t1,t2], [(1,640,640,3),(1,640,640,3)], cvcuda.Interp.LINEAR)
